...
Panel3.setPaintRoutine(function(g)
{
	if(Panel3.data.activator == 1)
		...
		g.drawAlignedText(Panel3.data.valueMeter, [0,0,this.getWidth(), this.getHeight()], "left");
});

Panel3.setTimerCallback(function()
{
	var l = Engine.getMasterPeakLevel(0);
	var r = Engine.getMasterPeakLevel(1);
	
	Panel3.data.valueMeter = Math.max(l, r);
